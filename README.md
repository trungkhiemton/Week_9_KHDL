...
Dự án này thực hiện đánh giá và so sánh thực nghiệm hiệu năng của thuật toán **FINCH** (First Integer Neighbor Clustering Hierarchy) với các phương pháp phân cụm phổ biến như **DBSCAN, K-Means, Spectral Clustering, HAC** và **Affinity Propagation (AP)**.
